...
public enum BuildType {
    ...
    HOTDOGSTAND(2,1,"Hotdog stand",10000,0,Assets.Texture.HOTDOGSTAND),
    ICECREAMPARLOR(2,1,"Ice cream parlor",15000,0,Assets.Texture.ICECREAMPARLOR),
    BURGERJOINT(2,1,"Burger joint",25000,0,Assets.Texture.BURGERJOINT),
    CAROUSEL(2,2,"Carousel",15000,0,Assets.Texture.CAROUSEL),
    FERRISWHEEL(3,3,"Ferriswheel",25000,0,Assets.Texture.FERRISWHEEL),
    SWINGINGSHIP(3,3,"Swinging ship",20000,0,Assets.Texture.SWINGINGSHIP),
